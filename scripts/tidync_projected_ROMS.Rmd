...
```{r}
bt_gfdl_fl <- here('data','bt_daily_roms_gfdl_1980_2100.nc')
...
```{r}
oxygen_gfdl_2035 <- pull_season_df(here('data','oxygen_bottom_daily_roms_gfdl_1980_2100.nc'),yr=2035)
```
